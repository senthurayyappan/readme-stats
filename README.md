<div align="center">
  ...
  <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; margin-bottom: 8px;">
    <div style="border: 1px solid #7c848c; border-radius: 5px; padding: 8px;">
  ...
  <!-- Traffic Chart -->
  <div style="border: 1px solid #7c848c; border-radius: 5px; padding: 8px; margin-bottom: 8px;">
  ...
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;">
    <!-- Coding Stats -->
    <div style="border: 1px solid #7c848c; border-radius: 5px; padding: 8px;">
      <img src="/../../raw/data/data/all_time-coding-stats.svg" alt="All Time Coding Stats" width="100%">
    </div>
    <div style="border: 1px solid #7c848c; border-radius: 5px; padding: 8px;">
      <img src="/../../raw/data/data/last_7_days-coding-stats.svg" alt="Last 7 Days Coding Stats" width="100%">
    </div>
    <div style="border: 1px solid #7c848c; border-radius: 5px; padding: 8px;">
  ...
  <div style="margin-top: 16px;">
    ...
    <a href="mailto:senthurayyappan@gmail.com"><img alt="Gmail" src="https://img.shields.io/badge/-Gmail-red"></a>
  </div>
</div>
